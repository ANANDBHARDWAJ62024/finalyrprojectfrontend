...
<div>
   ...
   :
     <div class="card" style={{marginBottom:'0px',  background:'#0099cc', color: "whitesmoke",width:'100%', height:'100%',fontFamily:"Proxima Nova",fontWeight:"bold"}} className="text-center">
