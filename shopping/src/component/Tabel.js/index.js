...
const Tabel = (props) => {
 ...
 { Users.map((user,idx)=>{
  ...
  See Order
    ...
    :
    <div class="card" style={{margin:'auto',color:"#0099cc",background:'transparent',height:'100px',fontFamily:"Proxima Nova", fontWeight:"bold",fontSize:"30px"}} className="text-center">
