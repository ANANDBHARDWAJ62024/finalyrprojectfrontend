...
<>
<div class="card" style={{margin:'auto',background:'transparent', color: "black", height:'100px'}} className="text-center">
      <h1>Order Detail !!</h1>
      </div>
...
<>
 ...
 :
 <div class="card" style={{margin:'0rem',background:'transparent', color: "whitesmoke", height:'100px'}} className="text-center">
