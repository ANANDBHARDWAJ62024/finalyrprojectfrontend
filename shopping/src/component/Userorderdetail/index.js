...
const Userorderdetail = (props) => {
  ...
  return(
    ...
    <div class="card" style={{margin:'auto',background:'transparent', color: "black", height:'100px',fontFamily:"Proxima Nova", fontSize:"30px", fontWeight:"bold"}} className="text-center">
...
<Form.Group>
  ...
  <Form.Group>
    ...
    <Form.Control placeholder={grandtotal} value={grandtotal} disabled />
     ...
     :
     <div class="card" style={{margin:'auto',background:'transparent', color: "whitesmoke",width:'auto', height:'auto',fontFamily:"Proxima Nova", fontSize:"30px", fontWeight:"bold"}} className="text-center">
