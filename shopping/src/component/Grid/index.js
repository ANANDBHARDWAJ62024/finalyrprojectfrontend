...
const Grid = (props) => {
  ...
  return(
    ...
    { length >0 ?
     ...
     :
     <div class="card" style={{marginBottom:'0px',margin:"auto", background:'#0099cc', color: "whitesmoke",width:'100%', height:'120%',fontFamily:"Proxima Nova",fontWeight:"bold"}} className="text-center">
