...
fetch("http://localhost:3005/user/getorder",{
  ...
  return(
    <>
         {length > 0 ? 
           <div id ="userorder"> 
      <div class="card" style={{margin:'0rem',background:'transparent',height:'100px'}} className="text-center">
      <h1>Your Order!! </h1>
      </div>
     {order.map((ordr,idx)=>{
       return(
...
<div class="card" style={{margin:'auto',background:'transparent',height:'100px'}} className="text-center">
