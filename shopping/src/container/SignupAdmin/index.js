...
const SignupAdmin = (props) => {
  ...
  return(
    <>
 <Layout></Layout>
    <div class="card" style={{margin:'0rem',background:'#007a99', color: "whitesmoke", height:'100px',fontFamily:"Proxima Nova", fontWeight:"bold",fontSize:"30px"}} className="text-center">
